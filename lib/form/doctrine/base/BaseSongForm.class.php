...
abstract class BaseSongForm extends BaseFormDoctrine
{
  public function setup()
  {
    $this->setWidgets(array(
      ...
      'isremix'          => new sfWidgetFormInputText(),
      'echonest_flagged' => new sfWidgetFormInputText(),
    ...
    $this->setValidators(array(
      ...
      'isremix'          => new sfValidatorInteger(array('required' => false)),
      'echonest_flagged' => new sfValidatorInteger(array('required' => false)),
