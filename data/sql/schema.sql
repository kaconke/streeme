...
CREATE TABLE song (id INTEGER PRIMARY KEY AUTOINCREMENT, scan_id INTEGER DEFAULT 0, unique_id VARCHAR(255), artist_id INTEGER DEFAULT 0, album_id INTEGER DEFAULT 0, name VARCHAR(255), length VARCHAR(255), accurate_length INTEGER DEFAULT 0, filesize INTEGER DEFAULT 0, bitrate INTEGER DEFAULT 0, yearpublished INTEGER DEFAULT 1969, tracknumber INTEGER DEFAULT 1, label VARCHAR(255), isremix INTEGER DEFAULT 0, echonest_flagged INTEGER DEFAULT 0, mtime INTEGER, atime INTEGER, filename TEXT, comments TEXT);
