...
abstract class BaseSongFormFilter extends BaseFormFilterDoctrine
{
  public function setup()
  {
    $this->setWidgets(array(
      ...
      'artist_id'       => new sfWidgetFormFilterInput(array('with_empty' => false)),
      'album_id'        => new sfWidgetFormFilterInput(array('with_empty' => false)),
      'genre_id'        => new sfWidgetFormFilterInput(array('with_empty' => false)),
      'last_scan_id'    => new sfWidgetFormFilterInput(array('with_empty' => false)),
      'name'            => new sfWidgetFormFilterInput(),
      'length'          => new sfWidgetFormFilterInput(),
      'accurate_length' => new sfWidgetFormFilterInput(array('with_empty' => false)),
      'filesize'        => new sfWidgetFormFilterInput(array('with_empty' => false)),
      'bitrate'         => new sfWidgetFormFilterInput(array('with_empty' => false)),
      'yearpublished'   => new sfWidgetFormFilterInput(array('with_empty' => false)),
      'tracknumber'     => new sfWidgetFormFilterInput(array('with_empty' => false)),
      'label'           => new sfWidgetFormFilterInput(),
      'mtime'           => new sfWidgetFormFilterInput(array('with_empty' => false)),
      'atime'           => new sfWidgetFormFilterInput(array('with_empty' => false)),
