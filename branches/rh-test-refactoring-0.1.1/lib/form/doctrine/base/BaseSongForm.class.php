...
abstract class BaseSongForm extends BaseFormDoctrine
{
  public function setup()
  {
    ...
    $this->setValidators(array(
      ...
      'accurate_length' => new sfValidatorInteger(),
      'filesize'        => new sfValidatorInteger(),
      'bitrate'         => new sfValidatorInteger(),
      'yearpublished'   => new sfValidatorInteger(),
      'tracknumber'     => new sfValidatorInteger(),
      'label'           => new sfValidatorString(array('max_length' => 255, 'required' => false)),
      'mtime'           => new sfValidatorInteger(),
      'atime'           => new sfValidatorInteger(),
