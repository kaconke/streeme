...
abstract class BaseSongFormFilter extends BaseFormFilterDoctrine
{
  public function setup()
  {
    $this->setWidgets(array(
      ...
      'echonest_flagged' => new sfWidgetFormFilterInput(),
    ...
    $this->setValidators(array(
      ...
      'echonest_flagged' => new sfValidatorSchemaFilter('text', new sfValidatorInteger(array('required' => false))),
