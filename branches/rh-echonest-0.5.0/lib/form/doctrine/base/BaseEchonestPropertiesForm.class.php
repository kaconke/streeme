...
abstract class BaseEchonestPropertiesForm extends BaseFormDoctrine
{
  public function setup()
  {
    $this->setWidgets(array(
      ...
      'en_location'           => new sfWidgetFormInputText(),
      ...
      'en_artist_hotttnesss'  => new sfWidgetFormInputText(),
      'en_artist_familiarity' => new sfWidgetFormInputText(),
      'en_latitude'           => new sfWidgetFormInputText(),
      'en_longitude'          => new sfWidgetFormInputText(),
    ));
    ...
    $this->setValidators(array(
      ...
      'en_location'           => new sfValidatorString(array('max_length' => 255, 'required' => false)),
      ...
      'en_artist_hotttnesss'  => new sfValidatorNumber(array('required' => false)),
      'en_artist_familiarity' => new sfValidatorNumber(array('required' => false)),
      'en_latitude'           => new sfValidatorNumber(array('required' => false)),
      'en_longitude'          => new sfValidatorNumber(array('required' => false)),
    ));
